...
describe('looksLikeCompletionBriefIntent', () => {
    describe('null / empty inputs', () => {
        ...
        it('returns false for undefined', () => expect(looksLikeCompletionBriefIntent(undefined)).toBe(false));
        it('returns false for empty string', () => expect(looksLikeCompletionBriefIntent('')).toBe(false));
        it('returns false for whitespace', () => expect(looksLikeCompletionBriefIntent('   ')).toBe(false));
    });
    ...
    describe('completion brief', () => {
        ...
        it('matches mixed case', () => expect(looksLikeCompletionBriefIntent('Completion Brief please')).toBe(true));
    ...
    describe('\\bCB\\b', () => {
        it('matches standalone CB', () => expect(looksLikeCompletionBriefIntent('can you do the CB now?')).toBe(true));
        it('matches CB at sentence start', () => expect(looksLikeCompletionBriefIntent('CB please')).toBe(true));
        it('does not match CBC', () => expect(looksLikeCompletionBriefIntent('CBC is a network')).toBe(false));
        it('does not match backup', () => expect(looksLikeCompletionBriefIntent('backup the files')).toBe(false));
    ...
    describe('next phase', () => {
        it("matches 'next phase'", () => expect(looksLikeCompletionBriefIntent("let's move to next phase")).toBe(true));
        ...
        it('matches mixed case', () => expect(looksLikeCompletionBriefIntent("Let's Go To Next Phase")).toBe(true));
    });

    describe('generate summary', () => {
        it('matches exact phrase', () => expect(looksLikeCompletionBriefIntent('generate summary')).toBe(true));
    ...
    describe('phase transition', () => {
        ...
        it('matches mixed case', () => expect(looksLikeCompletionBriefIntent('Phase Transition')).toBe(true));
    });
    ...
    describe('extra heuristics (wrap/close/finish phase)', () => {
        ...
        it("matches 'wrap up phase'", () => expect(looksLikeCompletionBriefIntent('wrap up phase')).toBe(true));
        it("matches 'close out this phase'", () =>
            expect(looksLikeCompletionBriefIntent('close out this phase')).toBe(true));
        it("matches 'finish this phase'", () => expect(looksLikeCompletionBriefIntent('finish this phase')).toBe(true));
