/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false --strict-vars=false` (hash: a76e5824642f87f1668cf1410b75ddbb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "LANGFUSE_HOST" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_ENVIRONMENT" | "CORS_ALLOWED_ORIGIN" | "CHAT_OUTPUT_SAFETY_ENABLED" | "POSTHOG_HOST" | "ALLOWED_PRESETS" | "BLOCKED_PRESETS" | "DEFAULT_PRESET" | "WORKER_NAME" | "WORKER_NAME_FULL" | "ENV">> {}
}
