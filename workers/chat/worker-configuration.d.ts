/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false --strict-vars=false` (hash: e3b01bf55789428ff852ef65ac998c60)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "LANGFUSE_HOST" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_ENVIRONMENT" | "CORS_ALLOWED_ORIGIN" | "CHAT_OUTPUT_SAFETY_ENABLED" | "POSTHOG_HOST" | "ALLOWED_PRESETS" | "DEFAULT_PRESET" | "WORKER_NAME" | "WORKER_NAME_FULL" | "ENV">> {}
}
