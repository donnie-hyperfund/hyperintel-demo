...
import { MessageSquare, Code, Layers, FileCode, Loader2 } from "lucide-react"
    ...
    <div className="flex h-screen bg-background text-foreground">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div ref={containerRef} className="flex-1 flex overflow-hidden relative">
          {/* Left Panel */}
          <div className="bg-card flex flex-col border-r border-border" style={{ width: `${leftPanelWidth}%` }}>
            {/* Messages */}
