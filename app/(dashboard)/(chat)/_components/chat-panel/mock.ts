...
export const MOCK_MESSAGES = [
    ...
    },
    {
        id: '4',
        role: 'assistant',
        content: `I've prepared a comprehensive audit guide for PPA revenue recognition.

:::artifact{identifier="ppa-audit-guide" type="text/markdown" title="PPA Revenue Recognition Audit Guide"}
\`\`\`markdown
