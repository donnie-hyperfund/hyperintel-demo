...
import { ConfirmUploadSchema } from '@/lib/schema/artifact';
import { confirmUploadHandler } from '@/workers/chat/src/uploads/artifact-uploader';
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const result = await confirmUploadHandler(parsed.data, ctx);
